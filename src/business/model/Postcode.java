...
public class Postcode implements Serializable, Validatable, Comparable<Postcode>  {
	...
	/**
	 * Verify structure of postcode using a simplified rule, structure of postcodes is
	 * verified as opposed to the character makeup. General postcodes are also allowed;
	 * this is where a postcode does not have to be complete meaning many postcodes
	 * falling under it. An example of this is PO7 7** would include PO7 7NH and PO7 8ED
	 * as valid options. An initial area code is the only enforced part.
	 * Valid for postcodes: A9 9AA, A9A 9AA, A99 9AA, AA9 9AA, AA9A 9AA, AA99 9AA
	 * 
