...
/**
 * Abstract model class for displaying a list of objects. Each row is represented as
 * a single object. Implementations of this model dictate how these objects are displayed.
 * Column classes can be explicitly set to avoid requiring table structure remake if a
 * new record is added to a blank model.
 * 
