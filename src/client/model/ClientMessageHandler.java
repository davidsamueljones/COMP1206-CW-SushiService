...
public class ClientMessageHandler extends MessageHandler {
	...
	/**
	 * Handle the response from a login attempt. Expect a message with a customer attached.
	 * Null object implies rejected login. Store response in alert object.
	 * 
	...
	/**
	 * Handle the response from a postcode request. Expect a message with an array of
	 * postcodes attached. Store response in alert object.
	 * 
	...
	/**
	 * Handle the response from a dish request. Expect a message with an array of
	 * dishes attached. Store response in alert object.
	 * 
	...
	/**
	 * Handle the response from an existing order request. Expect a message with an array of
	 * orders attached. Store response in alert object.
	 * 
